...
<header class="brand"><h1>Car Repair Shop</h1></header>
    <div class="container" style="background-color: crimson; width: 100%;">
        <p style="color: white ; text-align: center ">  Welcome, <?php echo $_SESSION['name']?></p>
        <form method="post">
            <input style=" height: 50px; width: 80px; background-color: green; color: white;" type="submit" name="lout" value="Log out">
        </form>
    </div>
    <?php
        // on clicking Log-Out
    ...
    <div class="container" style="width: 900px">
        ...
        <table style="width:100%">
            ...
            <tr>
                <td><img src="../img/man1.jpg" alt="Avilable Mechanic"></td>
                <td>Md. Shamiul Shuvo</td>
                <td>Skilled Auto Mechanic to maintain and repair vehicles</td>
            ...
            <tr>
                <td><img src="../img/man2.jpg" alt="Avilable Mechanic"></td>
            ...
            <tr>
                <td><img src="../img/man3.jpg" alt="Avilable Mechanic"></td>
            ...
            <tr>
                <td><img src="../img/young-man.jpg" alt="Avilable Mechanic"></td>
                <td>Naimul Haque</td>
                <td>Skilled Auto Mechanic to maintain and repair vehicles</td>
